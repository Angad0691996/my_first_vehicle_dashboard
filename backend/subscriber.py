...
db_config = {
    'user': os.getenv('DB_USER', 'vehicledbuser'),
    'password': os.getenv('DB_PASSWORD', 'Mycloud@25'),
    'host': os.getenv('DB_HOST', 'localhost'),  # will use mysql-db from .env
    'database': os.getenv('DB_NAME', 'vehicle_dashboard'),
...
mqttc = paho.Client(paho.CallbackAPIVersion.VERSION1)
